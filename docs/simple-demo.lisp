...
(:CL-CFSSL-CLIENT)
* (defvar *local-server*
    (cfssl-client:new-server "127.0.0.1"))

*LOCAL-SERVER*
* (defvar *remote-server*
    (cfssl-client:new-server "ca.example.org"))
...
*CERTIFICATE-REQUEST*
* (defvar *key-and-csr*
    (cfssl-client:new-key-and-csr *local-server* *certificate-request*))
